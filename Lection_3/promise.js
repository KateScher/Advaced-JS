...
// // fetchData("https://api.example.com/data") - с данным адресом будет ошибка
// fetchData("https://randombig.cat/roar.json") // это картинка
//   .then((data) => {
...
//   setTimeout(() => resolve(1), 1000); // Верни 1 через секунду
// })
